...
export const thematics: Thematic[] = [
  {
    id: 1,
    title: "Education",
    desc: "HFC is committed to providing comprehensive support for education, from kindergarten to university level. Their support includes school materials, uniforms, school fees, and tutorials. By providing these resources, HFC ensures that children have the tools they need to succeed in school.",
    desc2:
      "Thanks to HFC, more children are able to attend school and achieve their dreams.",
    link: "/",
    imageUrl: "",
  },
  {
